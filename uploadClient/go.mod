module github.com/pk5ls20/NekoImageWorkflow/uploadClient
...
require (
	...
	github.com/kitex-contrib/obs-opentelemetry/logging/logrus v0.0.0-20240423095615-4bd94c002638 // indirect
